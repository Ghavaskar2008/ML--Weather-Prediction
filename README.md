...
## Algorithm
1. Load the weather dataset, select the required features, and handle missing values using the mean value of each column.1. 
2. Split the dataset into training and testing sets for Pollution (PM2.5), Temperature, and Energy (TSR) prediction.
3. Train separate DecisionTreeRegressor models for each target variable using the training data.
4. Predict the test data results and evaluate the models using RMSE, R² Score, and Accuracy percentage.
## Program:
```
...
<img width="522" height="337" alt="image" src="https://github.com/user-attachments/assets/18139f73-c88d-48f8-a063-0f4254fbb96e" />
